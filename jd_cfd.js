...
$.result = [];
$.shareCodes = [
'130FCAA6299143E358E2649129935299DDBF7AC8072E8C7B2B2A8432B9239171'
];
...
!(async () => {
  ...
  await requestAlgo();
  await $.wait(1000)
  let res = await getAuthorShareCode('https://raw.fastgit.org/asd920/updateTeam/main/shareCodes/cfd.json')
  if (!res) {
